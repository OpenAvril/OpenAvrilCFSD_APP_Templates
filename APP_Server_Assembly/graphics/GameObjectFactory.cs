...
using OpenTK;
using OpenAvrilCFSD.ServerAssembly.Graphics.GameObjects;
using OpenAvrilCFSD.ServerAssembly.Graphics.Renderables;
using ServerAssembly.GameInstance;

namespace OpenAvrilCFSD.ServerAssembly.Graphics
{
    public class GameObjectFactory : IDisposable
    {
        ...
        private OpenAvrilCFSD.ServerAssembly.GameInstance.Player _player;
        ...
        {
            _player = new OpenAvrilCFSD.ServerAssembly.GameInstance.Player(
                _models["Player"],
        ...
        public OpenAvrilCFSD.ServerAssembly.GameInstance.Player Get_player()
        {
            return _player;
        }
    }
