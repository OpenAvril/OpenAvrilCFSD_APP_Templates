namespace OpenAvrilCFSD.ServerAssembly
{
    public class Data_Control
    {
        ...
        public void Push_Stack_InputActions(
            List<OpenAvrilCFSD.ServerAssembly.Inputs.Input> stack_InputAction,
            OpenAvrilCFSD.ServerAssembly.Inputs.Input buffer_Back_Input
        )
        {
        ...
        public void Push_Stack_OutputRecieve(
            List<OpenAvrilCFSD.ServerAssembly.Outputs.Output> stack_OutputRecieve,
            OpenAvrilCFSD.ServerAssembly.Outputs.Output buffer_TransmitOutput
        )
        {
        ...
        public void Pop_Stack_InputActions(
            OpenAvrilCFSD.ServerAssembly.Inputs.Input buffer_Transmit_Input,
            List<OpenAvrilCFSD.ServerAssembly.Inputs.Input> stack_InputAction
        )
        {
        ...
        public void Pop_Stack_OutputRecieve(
            OpenAvrilCFSD.ServerAssembly.Outputs.Output buffer_Back_Output,
            List<OpenAvrilCFSD.ServerAssembly.Outputs.Output> stack_OutputRecieve
        )
        {
