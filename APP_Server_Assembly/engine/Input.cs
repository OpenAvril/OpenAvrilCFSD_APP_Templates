...
namespace OpenAvrilCFSD.ServerAssembly.Inputs
{
    public class Input
    {
        private OpenAvrilCFSD.ServerAssembly.Inputs.Input_Control _input_Control;
        ...
        public Input()
        {
            ...
            Set_praiseEventId(0);
            System.Console.WriteLine("OpenAvrilCFSD.ServerAssembly: Input");
        }

        public void InitialiseControl() 
        {
            Set_input_Control(new OpenAvrilCFSD.ServerAssembly.Inputs.Input_Control());
            while (Get_input_Control() == null) { }
        }
        public OpenAvrilCFSD.ServerAssembly.Inputs.Input_Control Get_input_Control()
        {
