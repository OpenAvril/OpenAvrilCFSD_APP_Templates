...
using OpenAvrilCFSD.ServerAssembly.Graphics;
...
namespace OpenAvrilCFSD.ServerAssembly
{
    public sealed class Game_Instance : GameWindow
    {
        ...
        protected override void OnUpdateFrame(FrameEventArgs e)
        {
            ...
            if(OpenAvrilCFSD.ServerAssembly.Program.Get_framework_Server().Get_server().Get_execute().Get_execute_Control().Get_exitApplication() == false)
            {
