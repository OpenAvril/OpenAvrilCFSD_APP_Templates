...
namespace OpenAvrilCFSD.ClientAssembly.Graphics
{
    public class GameObjectFactory : IDisposable
    {
        ...
        private OpenAvrilCFSD.ClientAssembly.GameInstance.Player _player;
        ...
        {
            _player = new OpenAvrilCFSD.ClientAssembly.GameInstance.Player(
                _models["Player"],
        ...
        public OpenAvrilCFSD.ClientAssembly.GameInstance.Player Get_player()
        {
            return _player;
        }
    }
