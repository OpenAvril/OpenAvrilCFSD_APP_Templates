...
using OpenAvrilCFSD.ClientAssembly.Graphics.GameObjects;
using OpenAvrilCFSD.ClientAssembly.Graphics.Renderables;
using OpenAvrilCFSD.ClientAssembly.Graphics;
using Valve.Sockets;
...
namespace OpenAvrilCFSD.ClientAssembly
{
    public sealed class Game_Instance : GameWindow
    {
        ...
        private Output _gameData_Output;
        ...
        private void HandleMouse(OpenAvrilCFSD.ClientAssembly.Framework_Client obj)
        {
        ...
        private void HandleKeyboard(OpenAvrilCFSD.ClientAssembly.Framework_Client obj, double dt)
        {
        ...
        public Output Get_gameData_Output()
        {
