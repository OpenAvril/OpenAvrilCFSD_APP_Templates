...
// public.
        ...
        {
            return dyn_CLASS_get_algorithms();
        }
        public Data Get_dyn_CLASS_data()
        {
            return Get_dyn_CLASS_data();
        }
        public Execute dyn_CLASS_get_execute()
        {
            return dyn_CLASS_get_execute();
        }
        public Global dyn_CLASS_get_global()
        {
            return dyn_CLASS_get_global();
        }
...
// private.
        ...
        static private void stat_CLASS_boot3_INITIALISE_algorithms()
        {
            ...
            while (dyn_CLASS_get_algorithms() == null) { }
        }
        ...
        static private void stat_CLASS_boot3_INITIALISE_execute()
        {
            ...
            while (dyn_CLASS_get_execute() == null) { }
        }
        ...
        static private void stat_CLASS_boot3_INITIALISE_global()
        {
            ...
            while (dyn_CLASS_get_global() == null) { }
        }
        static private Algorithims dyn_CLASS_get_algorithms()
        {
            return _stat_CLASS_algorithms;
        }
        static private Data Get_dyn_CLASS_data()
        {
            return _stat_CLASS_data;
        }
        static private Execute dyn_CLASS_get_execute()
        {
            return _stat_CLASS_execute;
        }
        static private Global dyn_CLASS_get_global()
        {
